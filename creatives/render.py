...
Die Motive kommen ohne Fotos aus: sie arbeiten nur mit Typografie, den
CI-Farben und dem Logo. Neue Motive ergänzt man im MOTIVE-Array in
index.html und ruft dieses Skript erneut auf.
"""
import functools
import glob
import http.server
